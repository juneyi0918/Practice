...
# get start tme 
start_ticks = pygame.time.get_ticks()  # get start time information
...
while running:
    ...
    # how many time spend?
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000  # (change ms -> s )
    ...
    # Game over when time is less or equal to 0
...
pygame.time.delay(2000) # delay 2 sec before end
